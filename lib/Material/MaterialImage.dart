...
class MaterialImage extends StatefulWidget {
  ...
  const MaterialImage({Key? key, required this.image, required this.video}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: widget.video ? new Center(
          child: new Icon(Icons.play_arrow , size: 60 , color: appColor.withOpacity(0.8)),
        ) : new Container(),
      ),
    );
