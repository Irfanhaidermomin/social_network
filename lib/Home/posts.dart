      ...
      child: new Column(
        children: [
          new PostsCard(
            ...
            numberPost: 4,
            image: 'post3.jpg',
            details: "Learn from yesterday, live for today, hope for tomorrow. The important thing is not to stop questioning (Albert Einstein) ",
            original: true,
            urlVideo: '',
            video: false,
            divider: '',
...
class PostsCard extends StatefulWidget {
  ...
  const PostsCard({Key? key, required this.name, required this.profile, required this.image, required this.likeCount, required this.commentCount, required this.createdAt, required this.follower, required this.following, required this.bio, required this.posts, required this.numberPost, required this.children, required this.details, required this.original, required this.video, required this.urlVideo, required this.divider, required this.online}) : super(key: key);
      ...
      children: [
        Stack(
          ...
          children: [
              ...
              children: [
                Stack(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        widget.video == false ? clickShowDetails() : print(
                            'click');
                      },
                      onDoubleTap: () {
                        setState(() {
                      ...
                      child: showDetails ? new GestureZoomBox(
                        child: new Container(
                          height: 330,
                          width: 360,
                    ...
                    showDetails ? new Container() : Padding(
            ...
            widget.video == false ? showDetails ? new Container() : Container(
              padding: const EdgeInsets.all(0),
              child: Container(
                  height: 105,
                  width: 360,
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(top: 8),
                                        child: new Text(widget.createdAt,
                                            style: TextStyle(
                                                color: Colors.white,
                                                fontWeight: FontWeight.bold)),
                                      ),
        ...
        widget.divider == 'end' ? new SizedBox(height: 50) : Padding(
...
class PostsProfile extends StatefulWidget {
  ...
  const PostsProfile({Key? key, required this.name, required this.profile, required this.follower, required this.following, required this.bio, required this.posts, required this.numberPost, required this.image, required this.children, required this.original, required this.online}) : super(key: key);
  @override
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  border: Border.all(color: followUnFollow ? appColor : Colors.white),
                                  borderRadius: BorderRadius.circular(8),
                                ),
                                child: new Material(
                                  color: followUnFollow ? Colors.white : Colors.blue,
                                  elevation: 0,
                                  borderRadius: BorderRadius.circular(8),
                                ...
                                Padding(
                                  ...
                                  child: new Row(
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          new Text(widget.posts, style: TextStyle(
                                              fontSize: 20,
                                              color: appColor)),
                                      ...
                                      Column(
                                        children: [
                                          new Text(
                                              widget.follower, style: TextStyle(
                                              fontSize: 20,
                                              color: appColor)),
                                      ...
                                      Column(
                                        children: [
                                          new Text(widget.following.toString(),
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                new Text(widget.name, style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.bold,
                                    color: appColor)),
                                widget.original ? Padding(
                                  padding: const EdgeInsets.all(8),
                                  child: new Icon(
